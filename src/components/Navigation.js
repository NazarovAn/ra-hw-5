  ...
  return (
    <div className="navigation">
      ...
      <div className={ `navigation__list ${ visibility ? '' : 'hidden' }` }>
        <NavLink to="/first" activeStyle={ activeStyle }>Карточки</NavLink>
        <NavLink to="/second" activeStyle={ activeStyle }>Декомпозиция</NavLink>
        <NavLink to="/third" activeStyle={ activeStyle }>Collapse</NavLink>
      </div>
    </div>
  )
}
